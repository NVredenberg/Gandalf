...
import { fallbackKiMapping, splitMethodSections } from "./rendererHeuristics.js";
...
export async function renderLearningDocument(input, kiMappings = {}) {
...
export const __docxRendererInternals = Object.freeze({
  fallbackKiMapping,
  splitMethodSections
});
